...
public class AddPackageForCustomerSingleCompanyMerchantDistributionOngoing extends BaseTest {
    ...
    public void AddPackageForCustomerSingleCompanyMerchantDistributionOngoingP() throws InterruptedException {
        ...
        actions.sendKeys(Keys.ENTER).perform();  // MerchantDistribution is chosen
        ...
        descriptionAndSearch = "Selenium package for MerchantDistribution + " + new Random().nextInt();
        ...
        actions.sendKeys("MerchantDistribution").perform();
