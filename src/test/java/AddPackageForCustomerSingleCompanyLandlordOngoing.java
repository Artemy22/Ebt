...
public class AddPackageForCustomerSingleCompanyLandlordOngoing extends BaseTest {
    ...
    public void AddPackageForCustomerSingleCompanyLandlordOngoingP() throws InterruptedException {
        ...
        actions.sendKeys(Keys.ENTER).perform();  // Landlord is chosen
        ...
        descriptionAndSearch = "Selenium package for Landlord + " + new Random().nextInt();
        ...
        actions.sendKeys("Landlord").perform();
