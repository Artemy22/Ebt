...
public class AddPackageForCustomerSingleCompanyInvoiceAccountOngoing extends BaseTest {
    ...
    public void AddPackageCustomerAllCompaniesOngoing() throws InterruptedException {
        ...
        actions.sendKeys(Keys.ENTER).perform();  // Invoice Account is chosen
        ...
        descriptionAndSearch = "Selenium package for Invoice Account + " + new Random().nextInt();
        ...
        actions.sendKeys("Invoice Account").perform();
