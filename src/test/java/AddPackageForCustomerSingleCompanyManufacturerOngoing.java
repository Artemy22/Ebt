...
public class AddPackageForCustomerSingleCompanyManufacturerOngoing extends BaseTest {
    ...
    public void AddPackageForCustomerSingleCompanyManufacturerOngoingP() throws InterruptedException {
        ...
        actions.sendKeys(Keys.ENTER).perform();  // Manufacturer is chosen
        newPackagePopup.clickCompanyNameDropDown();
        actions.sendKeys("manuf").perform();
        Thread.sleep(1000);
        actions.sendKeys(Keys.ARROW_DOWN).perform();
        ...
        descriptionAndSearch = "Selenium package for Manufacturer + " + new Random().nextInt();
        ...
        actions.sendKeys("Manufacturer").perform();
