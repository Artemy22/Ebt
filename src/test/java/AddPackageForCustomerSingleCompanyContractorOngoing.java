...
public class AddPackageForCustomerSingleCompanyContractorOngoing extends BaseTest {
    ...
    public void AddPackageForCustomerSingleCompanyManufacturerOngoingP() throws InterruptedException {
        ...
        actions.sendKeys(Keys.ENTER).perform();  // Contractor is chosen
        newPackagePopup.clickCompanyNameDropDown();
        actions.sendKeys("Contr").perform();
        Thread.sleep(1000);
        actions.sendKeys(Keys.ARROW_DOWN).perform();
        ...
        descriptionAndSearch = "Selenium package for Contractor + " + new Random().nextInt();
        ...
        actions.sendKeys("Contractor").perform();
